...
**Status:** 🆕 new — the content/wrong-element half of the gate-2 audit, read from the emitted test file (`scratch/session7_evidence/emitted_test_file.py`). Found while closing B-088 (2026-09-24).
...
**Note:** the Session 8 re-run's emitted file was not preserved; the Session 7 file is the evidence for the shapes above (the re-run confirmed 31 passed, i.e. these checks still pass). A cheap follow-up is to have the re-run harness copy the emitted test file next to the suite log — then this audit is mechanical.
**Estimated sessions:** 1–1.5.
